...
CAMPO_NOME = driver.find_element_by_css_selector('#first-name').send_keys('Alex')
CAMPO_SOBRENOME = driver.find_element_by_css_selector('#last-name').send_keys('Pedro')
...
BOTAO_BACKHOME = driver.find_element_by_css_selector('#back-to-products').click()